...
export function background_map() {
    ...
    constants.ctx.drawImage(images.originalworldmapImg, constants.position_x - constants.ctx_width/2, constants.position_y - constants.ctx_height/2, constants.ctx_width, constants.ctx_height, 0, 0, constants.ctx_width, constants.ctx_height);
}
